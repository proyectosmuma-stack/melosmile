#!/usr/bin/env node
/**
 * Script to apply migration 005 to Supabase via Management API
 */
...
const migrationFile = path.join(__dirname, '../../supabase/migrations/20260722000005_treatments_and_clinic_rules.sql');
...
console.log(`📦 Applying migration 005: ${path.basename(migrationFile)}`);
