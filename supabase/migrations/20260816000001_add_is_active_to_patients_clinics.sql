-- supabase/migrations/20260816000001_add_is_active_to_patients_clinics.sql
-- Up migration
...
-- Down migration (nota: no ejecutar en up; el rollback se gestiona con supabase db reset)
